...
def parse_args():
    ...
    # Dataset
    arg_parser.add_argument("--partition",type=str,default="",)
    ...
    arg_parser.add_argument("--evaluate_rule", type=str, default=None)
    ...
    arg_parser.add_argument("--annealing", type=int, default=8)
