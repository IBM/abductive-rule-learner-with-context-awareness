...
def create_one_hot(puzzle, panel_constellation):
    ...
    num_panels = puzzle.shape[1]

    

    if panel_constellation == "center_single":
        exist_prob = torch.ones((batch_size, num_panels, 1, 2)) * eps
        type_prob = torch.ones((batch_size, num_panels, 1, DIM_TYPE)) * eps
        size_prob = torch.ones((batch_size, num_panels, 1, DIM_SIZE)) * eps
        color_prob = torch.ones((batch_size, num_panels, 1, DIM_COLOR)) * eps
    ...
    if panel_constellation == "distribute_four":
        ...
        type_prob = torch.ones((batch_size, num_panels, 4, 5)) * eps
        size_prob = torch.ones((batch_size, num_panels, 4, 6)) * eps
        color_prob = torch.ones((batch_size, num_panels, 4, 10)) * eps
    ...
    if panel_constellation == "distribute_nine":
        ...
        type_prob = torch.ones((batch_size, num_panels, 9, 5)) * eps
        size_prob = torch.ones((batch_size, num_panels, 9, 6)) * eps
        color_prob = torch.ones((batch_size, num_panels, 9, 10)) * eps
    ...
    if (panel_constellation == "left_right"or panel_constellation == "up_down"or panel_constellation == "in_out_single"):
        ...
        type_prob = torch.ones((batch_size, num_panels, 2, 5)) * eps
        size_prob = torch.ones((batch_size, num_panels, 2, 6)) * eps
        color_prob = torch.ones((batch_size, num_panels, 2, 10)) * eps
        exist_prob[:, :, 0, 1] = 1
        exist_prob[:, :, 1, 1] = 1
    ...
    if panel_constellation == "in_out_four":
        ...
        type_prob = torch.ones((batch_size, num_panels, 5, 5)) * eps
        size_prob = torch.ones((batch_size, num_panels, 5, 6)) * eps
        color_prob = torch.ones((batch_size, num_panels, 5, 10)) * eps
